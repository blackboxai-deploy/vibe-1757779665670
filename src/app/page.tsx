  ...
  const features = [
    {
      ...
      description: 'Advanced algorithms ensure your content passes through AI detection systems unnoticed, maintaining authenticity.',
      icon: '🛡️',
      gradient: 'bg-gradient-to-br from-green-500 to-green-600'
    },
    {
      title: 'Preserve Meaning',
      description: 'Our intelligent system maintains the original context and meaning while transforming the text structure.',
      icon: '🎯',
      gradient: 'bg-gradient-to-br from-blue-500 to-blue-600'
    },
    {
      title: 'Instant Processing',
      description: 'Get your humanized text in seconds with our optimized processing engine and real-time results.',
      icon: '⚡',
      gradient: 'bg-gradient-to-br from-yellow-500 to-orange-600'
    },
    {
      title: 'Multiple Languages',
      description: 'Support for various languages and content types including academic papers, articles, and creative writing.',
      icon: '🌍',
      gradient: 'bg-gradient-to-br from-purple-500 to-purple-600'
    },
    {
      title: 'Quality Assurance',
      description: 'Every output is carefully processed to ensure grammatical correctness and natural flow.',
      icon: '✨',
