      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-20 pb-16 text-center lg:pt-32">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 max-w-3xl mx-auto">
            Mr.JM AI Humanizer Tool uses advanced algorithms to convert AI-generated text into natural, 
            human-like content that bypasses AI detection systems while maintaining quality and meaning.
          </p>
